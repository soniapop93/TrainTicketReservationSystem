...
public class WinCred implements CredAdvapi32 {
    ...
    public class WinCredential {
        ...
        public WinCredential(String target, String username, String password) {
    ...
    public WinCredential getCredential(String target) {
        ...
        try {
            if (CredRead(target, 1, 0, pcredMem)) {
                ...
                WinCredential cred = new WinCredential(credMem.TargetName, credMem.UserName, password);
                return cred;
            } else {
